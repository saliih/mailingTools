...
$base_url="http://".$_SERVER["SERVER_NAME"]."/";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '../oze/medias/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../medias/'; // relative path from filemanager folder to upload folder (with final /)
